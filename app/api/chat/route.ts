...
export async function POST(request: NextRequest) {
  ...
  const systemPrompt = `Sos el analista de contenido de Instagram del creador. Tu trabajo es analizar datos reales de rendimiento de sus reels para ayudarlo a entender qué funciona y cómo crear mejor contenido.
